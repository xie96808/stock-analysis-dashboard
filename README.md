...
- [成交量与筹码分布模型](./docs/CHIP_DISTRIBUTION_MODEL.md)
- [成交量/筹码分布验收单](./docs/DISTRIBUTION_ACCEPTANCE_CHECKLIST.md)
...
- 成交量/筹码分布互斥切换，避免把区间成交与持仓成本混为一项；
- 按交易日换手递推、可固定历史基准日的A股筹码成本估算；
...
4. **概念清晰**：Volume Profile 与估算的筹码成本分布互斥呈现，并明确各自基准范围。
